defmodule PersonalHubWeb.TaskLive.Index do
  ...
  defp status_class("todo"),
    do: "rounded-full px-2.5 py-0.5 text-xs font-medium bg-amber-50 text-amber-700"

  defp status_class("in_progress"),
    do: "rounded-full px-2.5 py-0.5 text-xs font-medium bg-blue-50 text-blue-700"

  defp status_class("done"),
    do: "rounded-full px-2.5 py-0.5 text-xs font-medium bg-green-50 text-green-700"

  defp status_class(_),
    do: "rounded-full px-2.5 py-0.5 text-xs font-medium bg-gray-100 text-gray-600"

  defp priority_class("high"),
    do: "rounded-full px-2 py-0.5 text-xs font-medium bg-red-50 text-red-700"

  defp priority_class("medium"),
    do: "rounded-full px-2 py-0.5 text-xs font-medium bg-amber-50 text-amber-600"

  defp priority_class("low"),
    do: "rounded-full px-2 py-0.5 text-xs font-medium bg-gray-100 text-gray-600"

  defp priority_class(_),
    do: "rounded-full px-2 py-0.5 text-xs font-medium bg-gray-100 text-gray-600"
              ...
              <div class="flex items-center gap-3 mt-3 pt-3 border-t border-gray-100">
                <%= if task["status"] == "todo" do %>
                  <button
                    ...
                    class="px-3 py-1 rounded-lg text-xs font-medium border border-blue-200 text-blue-600 hover:bg-blue-50 transition-colors"
                  >
                    Start
                  </button>
                <% end %>
                <%= if task["status"] != "done" do %>
                  <button
                    phx-click="complete"
                    phx-value-id={task["id"]}
                    class="px-3 py-1 rounded-lg text-xs font-medium border border-green-200 text-green-600 hover:bg-green-50 transition-colors"
                  >
                    Done
                  </button>
                <% end %>
