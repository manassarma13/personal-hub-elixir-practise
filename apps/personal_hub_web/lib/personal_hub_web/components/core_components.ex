defmodule PersonalHubWeb.CoreComponents do
  @moduledoc """
    ...
    <div class="mb-2">
      <label for={@id} class="inline-flex items-center gap-2 cursor-pointer">
        ...
        <input
          ...
          value="true"
          checked={@checked}
          class={@class || "size-4 rounded border-gray-300 text-primary focus:ring-primary/20"}
          {@rest}
        />
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(PersonalHubWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(PersonalHubWeb.Gettext, "errors", msg, opts)
    end
  end
